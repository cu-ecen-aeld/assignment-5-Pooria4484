...
int Test_validate_username_main(void)
{
  UnityBegin("/home/pooria/colorado/assignment-1-Pooria4484/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
  run_test(test_validate_my_username, "test_validate_my_username", 7);
